...
@Component({
  selector: 'ngx-comparison-AOB_AAS-model',
  templateUrl: './comparison-AOB_AAS-model.component.html',
  styleUrls: ['./comparison-AOB_AAS-model.component.scss']
})
export class comparisonAOB_AASModelComponent {
