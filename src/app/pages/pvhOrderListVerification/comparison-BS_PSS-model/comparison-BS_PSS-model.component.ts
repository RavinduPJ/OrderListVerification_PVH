...
@Component({
  selector: 'ngx-comparison-BS_PSS-model',
  templateUrl: './comparison-BS_PSS-model.component.html',
  styleUrls: ['./comparison-BS_PSS-model.component.scss']
})
export class ComparisonBS_PSSModelComponent {
