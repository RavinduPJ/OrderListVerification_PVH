...
import { bffComponent_CKNA } from './bff.component';
...
import { ComparisonModalNewFileComponent } from './comparison-modal-new-file/comparison-modal-new-file.component';
@NgModule({
  imports: [
    ThemeModule,
    NbCardModule,
  ...
  declarations: [
    ...
    ComparisonModelComponent,
    ComparisonModalOtrComponent,
    ComparisonModalShipmentComponent,
    ComparisonModalNewFileComponent,
    ComparisonModalOlrComponent
  ],
  providers: [
    CountryOrdersMapService,
  ],
})
export class PVHCKNAOrderList { }
