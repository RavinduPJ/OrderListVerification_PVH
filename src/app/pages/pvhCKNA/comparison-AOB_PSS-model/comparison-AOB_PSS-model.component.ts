...
@Component({
  selector: 'ngx-comparison-AOB_PSS-model',
  templateUrl: './comparison-AOB_PSS-model.component.html',
  styleUrls: ['./comparison-AOB_PSS-model.component.scss']
})
export class ComparisonAOB_PSSModelComponent {
